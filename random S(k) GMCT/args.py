...
group.add_argument('--n_in', type=int, default=68, help='number of inputs')
group.add_argument('--n_out', type=int, default=1, help='number of outputs')
group.add_argument('--net_depth', type=int, default=9, help='number of total layers')
group.add_argument('--net_width','--list', nargs='+', default=(100, 200, 200, 100, 100, 50, 20), help='size of the hidden layers')
...
group.add_argument('--tolerance', type=float, default=1e-5, help='tolerance for training')
group.add_argument('--batch_size', type=int, default=300, help='training batch size')

group.add_argument(
    '--max_step', type=int, default=1000, help='maximum number of steps')
group.add_argument(
    '--clip_grad',
    type=float,
    default=0,

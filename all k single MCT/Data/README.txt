...
1. 	In the phi_data folder, the main output data is stored. 
	It contains 10^5 textfiles each containing the intermediate scattering function at a volume fraction specified in the name of the file.
	Each file contains three rows, the first row with the log10(t) data, the second with a k-value and the third row contains the associated F(k,t). 
